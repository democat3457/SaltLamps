...
public class BlockSaltLamp extends Block implements ITileEntityProvider {
  ...
  public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
    ...
    return (super.canPlaceBlockAt(worldIn, pos) && (
          downState.isSideSolid((IBlockAccess)worldIn, pos, EnumFacing.UP) ||
          blockFaceShape == BlockFaceShape.SOLID ||
          blockFaceShape == BlockFaceShape.CENTER ||
          blockFaceShape == BlockFaceShape.MIDDLE_POLE ||
          blockFaceShape == BlockFaceShape.CENTER_BIG ||
  ...
  public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
    IBlockState downState = worldIn.getBlockState(pos.down());
    BlockFaceShape blockFaceShape = downState.getBlockFaceShape((IBlockAccess)worldIn, pos.down(), EnumFacing.UP);
    if (!downState.isSideSolid((IBlockAccess)worldIn, pos, EnumFacing.UP) && 
        blockFaceShape != BlockFaceShape.SOLID &&
        blockFaceShape != BlockFaceShape.CENTER &&
        blockFaceShape != BlockFaceShape.MIDDLE_POLE &&
        blockFaceShape != BlockFaceShape.CENTER_BIG &&
