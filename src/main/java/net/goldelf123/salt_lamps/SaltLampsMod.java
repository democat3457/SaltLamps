...
@Mod(modid = "salt_lamps", name = "Salt Lamps Reforged", version = "1.12.2-1.1.0", dependencies = "required-after:forge@[14.23.5.2847,)", useMetadata = true)
@EventBusSubscriber
public class SaltLampsMod {

  public static final String MODID = "salt_lamps";
  public static final String MODNAME = "Salt Lamps Reforged";
